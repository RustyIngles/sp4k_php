<?php
    ...
    /**
     * Class Sp4kAppsEasycollectContractReactivate
     *
     * Where a payment schedule has a fixed length (is constrained by either a “Number of Payments” or “End on Exact Date” parameter),
     * providing the customer has not cancelled down the Direct Debit with their bank,
     * it is possible to re-use the existing Direct Debit Instruction after the original schedule has “expired”.
     *
     * Contracts eligible for a “restart” will have the status “Expired”.
     */
    class Sp4kAppsEasycollectContractReactivate
    {
        private $path = '/api/2.0/client/S4KID/contract/{GUID}/reactivate';
        private $method = 'POST';
