<?php
    ...
    trait Sp4kAppsSubscriptionTrait
    {
        /** @var  Sp4kTablesBase | Sp4kTablesNestedbase
        protected $_table = false; */
        
        protected $_key = 'id';
        protected $_table_alias = 'subscription';
            ...
            return
                $this->_table
                    ?
                        $this->_table
                    :
                        $this->_table = new Sp4kTablesBase('#__sp4k_subscription_items','id', $this->_table_alias);
        }
         ...
         *
         * @return \Sp4kAppsSubscriptionItem
         *
         */
        public function getItemInstance( Registry $state = null)
        {
            return Sp4kAppsSubscriptionItem::getInstance( $state );
        }
        
        /**
         * @param   Registry $state
         *
         * @return Sp4kAppsSubscriptionItems
         */
        public function getItemsInstance( Joomla\Registry\Registry $state = NULL )
        {
            return Sp4kAppsSubscriptionItems::getInstance($state);
        }
