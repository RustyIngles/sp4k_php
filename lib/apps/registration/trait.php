<?php
    ...
    trait Sp4kAppsRegistrationTrait
    {
        /** @var  Sp4kTablesBase | Sp4kTablesNestedbase
        protected $_table = false; */
        
        protected $_key = 'id';
        protected $_table_alias = 'registration';
        ...
        public function getTable()
        {
            return
                $this->_table
                    ...
                    $this->_table
                    :
                    $this->_table = new Sp4kTablesBase('#__sp4k_registration_items','id', $this->_table_alias);
        }
         ...
         *
         * @return \Sp4kAppsRegistrationItem
         *
         */
        public function getItemInstance( Registry $state = null)
        {
            return Sp4kAppsRegistrationItem::getInstance( $state );
        }
        
        /**
         * @param   Registry $state
         *
         * @return Sp4kAppsRegistrationItems
         */
        public function getItemsInstance( Joomla\Registry\Registry $state = NULL )
        {
            return Sp4kAppsRegistrationItems::getInstance($state);
        }
