...
class Sp4kModulesCartControllersReviewDisplay extends Sp4kBaseControllerDisplay
{
    public function execute()
    {
        if(JFactory::getUser()->guest){
            ...
            $model = new Sp4kModulesCartModelsReviewDisplay(
                new  Registry($this->input->getArray())
            );

            $view = new Sp4kModulesCartViewsReviewHtml($model);
        }
