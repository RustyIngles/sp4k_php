<?php
    ...
    class Sp4kModulesCartControllersAddDisplay extends Sp4kBaseControllerDisplay
    {
        public function execute()
        {
            if(JFactory::getUser()->guest){
                ...
                $model = Sp4kModulesCartModelsAddDisplay::getInstance(
                    new  Registry($this->input->getArray())
                );


                $view = new Sp4kModulesCartViewsAddHtml($model);
            }
